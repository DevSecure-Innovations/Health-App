...
import { View, Text, StyleSheet, ScrollView, Pressable, Image, TextInput, ImageSourcePropType } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import Animated, { FadeInUp } from 'react-native-reanimated';
import { Phone, MapPin, Clock, Search } from 'lucide-react-native';
import Color from '@/constants/color';

type AmbulancePropType = {
    id: number;
    name: string;
    image: string
    distance: string;
...
const ambulanceData: AmbulancePropType[] = [
    {
        id: 1,
        name: "Uttarpara Health Club",
        image: "https://images.unsplash.com/photo-1587745416684-47953f16f02f?w=500",
        distance: "0.5 km",
    ...
    {
        id: 2,
        name: "Kolkata Emergency Services",
        image: "https://images.unsplash.com/photo-1612277635895-b2a4f39de1d5?w=500",
        distance: "3 km",
    ...
    {
        id: 3,
        name: "Howrah First Response",
        image: "https://images.unsplash.com/photo-1576765607924-1c7eaa13086e?w=500",
        distance: "2 km",
        contact: "+91 78965 12340",
        available: false,
        eta: "15 minutes",
        location: "Howrah"
    },
